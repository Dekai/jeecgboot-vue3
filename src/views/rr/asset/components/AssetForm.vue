...
<script lang="ts">
  ...
  import {getBpmFormSchema,rrAssetChangeColumns} from '../Asset.data';
  ...
  export default defineComponent({
    ...
    setup(props){
      ...
      const queryByIdUrl = '/rr.asset/asset/queryById';
      async function initFormData(){
        let params = {id: props.formData.dataId};
        const data = await defHttp.get({url: queryByIdUrl, params});
        //设置表单的值
        await setFieldsValue({...data});
        requestSubTableData(rrAssetChangeList, {id: data.id}, rrAssetChangeTable, ()=>{
          rrAssetChangeTable.show = true;
        });
        //默认是禁用
