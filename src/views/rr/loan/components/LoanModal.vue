...
<script lang="ts" setup>
    ...
    import {formSchema,rrLoanChangeColumns} from '../Loan.data';
    ...
    const [registerModal, {setModalProps, closeModal}] = useModalInner(async (data) => {
        ...
        if (unref(isUpdate)) {
            ...
            await setFieldsValue({
             ...
             requestSubTableData(rrLoanChangeList, {id:data?.record?.id}, rrLoanChangeTable)
        }
        // 隐藏底部时禁用整个表单
    ...
    async function reset(){
      await resetFields();
      activeKey.value = 'rrLoanChange';
      rrLoanChangeTable.dataSource = [];
    }
