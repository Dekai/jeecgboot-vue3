...
<script lang="ts" setup>
    ...
    import {formSchema,loanChangeColumns} from '../Loan.data';
    ...
    const [registerModal, {setModalProps, closeModal}] = useModalInner(async (data) => {
        ...
        if (unref(isUpdate)) {
            ...
            await setFieldsValue({
             ...
             requestSubTableData(loanChangeList, {id:data?.record?.id}, loanChangeTable)
        }
        // 隐藏底部时禁用整个表单
    ...
    async function reset(){
      await resetFields();
      activeKey.value = 'loanChange';
      loanChangeTable.dataSource = [];
    }
